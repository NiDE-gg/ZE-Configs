// ----------------------
// Prevents infection while the user has the targetname life_leech
...
CollectEventsInScope({
	...
	OnScriptHook_OnTakeDamage = function(params) {
		...
		// Only cancel damage if the attacker is named "life_leech"
		if (params.attacker.GetName() == "life_leech") {
			params.damage = 0
