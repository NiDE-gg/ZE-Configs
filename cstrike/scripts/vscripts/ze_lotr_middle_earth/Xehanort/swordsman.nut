...
function OnPostSpawn(){
	...
	maxhealth = HITBOX.GetHealth()+(75*ctcount) // 300 starting hp + 200/per player
...
function Attack(){
	...
	EntFireByHandle(MODEL, "RunScriptCode", "damage=20", 0, null, null)	
	...
	switch (RandomInt(1,4)) {
		...
		default:
			...
			EntFireByHandle(MODEL, "RunScriptCode", "damage=50", 0.1, null, null)	
