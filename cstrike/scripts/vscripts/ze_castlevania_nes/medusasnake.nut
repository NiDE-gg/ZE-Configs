...
function OnPostSpawn(){
    ...
    maxhealth = HITBOX.GetHealth()+(20*ctcount) // 300 starting hp + 200/per player
    ...
    EntFireByHandle(MODEL, "SetPlaybackRate", "10", 0.15, null, null);
