...
function OnPostSpawn(){
	...
	EntFireByHandle(MODEL, "SetAnimation", "breach", 0, null, null);
	EntFireByHandle(MODEL, "SetPlaybackRate", "0.01", 0, null, null);
	local randomfloat = RandomFloat(1, 2.50)
	EntFireByHandle(MODEL, "SetPlaybackRate", "1", randomfloat, null, null);
